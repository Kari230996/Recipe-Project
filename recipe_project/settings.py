...
SECRET_KEY = 'django-insecure-w4av**)jbka*k$+mly#c4ps2l1%j*(znczelvg^iit4b--*us-'
...
# STATIC_URL = '/static/'
# STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Location to collect static files for deployment
